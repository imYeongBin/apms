...
<title>apms</title>
	...
	<link href="${path}/bootstrap/css/sb-admin-2.min.css" rel="stylesheet">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="${path}/bootstrap/img/undraw_posting_photo.svg" alt="">
                  </div>
